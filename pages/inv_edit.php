...
$opt .= "</select>";
  ...
  $query = 'SELECT PRODUCT_ID,PRODUCT_CODE, NAME,QTY_STOCK, ON_HAND, c.CNAME FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID  WHERE PRODUCT_ID ='.$_GET['id'];
  $result = mysqli_query($db, $query) or die(mysqli_error($db));
